...
| # | タイトル | Status |
|---|---------|--------|
| [0001](0001-tdd-bdd-test-pyramid-methodology.md) | TDD/BDD と Google テストピラミッドを開発方法論として採用 | accepted |
| [0002](0002-monorepo-layout-and-ddev-runtime.md) | モノレポ配置（slack_portal ＋ frontend）と DDEV ランタイム | accepted |
...
| [0009](0009-secrets-and-pii-handling.md) | secrets / PII の取扱 | accepted |
| [0010](0010-ci-pyramid-and-local-pr-gates.md) | CI（ピラミッド順）と local-ci / PR ゲート | accepted |
| [0011](0011-drupal-api-test-toolchain.md) | Drupal API テストツールチェーン（PHPUnit/PHPStan/PHPCS） | accepted |
